...
> **Mục đích:** Chức năng **độc lập** (không link DocType ERPNext có sẵn) để lập **Packing List** xuất hàng
...
## 12. Files
```
doctype/packing_list/               packing_list.{json,py,js}, packing_list.md
