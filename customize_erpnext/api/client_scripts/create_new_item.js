...
=======
async function find_next_code(frm, prefix) {
    // Get the item with the highest item_code matching the prefix
    let max_code = '000';
    const items = await frappe.db.get_list('Item', {
        filters: {
            'item_group': frm.doc.item_group,
>>>>>>> 524b6d32b23f34d4345250c2fdadbb14f167e33d
            'has_variants': 1
        },
        fields: ['item_code'],
...
=======
    ...
    if (frm.doc.item_group.includes("B-Finished Goods") || frm.doc.item_group.includes("C-Fabric") || frm.doc.item_group.includes("D-Interlining") || frm.doc.item_group.includes("E-Padding") || frm.doc.item_group.includes("F-Packing") || frm.doc.item_group.includes("G-Sewing") || frm.doc.item_group.includes("H-Thread")) {
>>>>>>> 524b6d32b23f34d4345250c2fdadbb14f167e33d
