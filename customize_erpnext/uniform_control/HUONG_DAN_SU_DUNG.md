...
**Chọn Mode (Chế độ):**
- **New Hires** — nhu cầu cho **nhân viên sẽ tuyển mới**, nhập trong bảng **Chức danh cần tuyển** (Designation + **Grade** tùy chọn + Số cần tuyển). **Áo sơ mi cấp theo Grade** → với **chức danh mới chưa có nhân viên**, hãy điền **Grade** để hệ thống tính được áo (giới tính/size lấy theo tỷ lệ toàn công ty). Bỏ trống Grade → suy từ nhân viên hiện tại của chức danh.
