...
> **Mục đích:** Module khám sức khoẻ định kỳ: phát hành và thu nhận hồ sơ khám, theo dõi kết quả.
> **Phạm vi:** Module Khám sức khoẻ
> **Trạng thái:** Đang chạy · **Cập nhật:** 2026-08-20

> Kết quả review toàn bộ module `health_check_up`. **Tất cả bug và improvement bên dưới đã được sửa ngày 2026-07-12** — xem mục 5 (Changelog). Tài liệu kỹ thuật chi tiết của trang quản lý: `page/health_check_up_management/health_check_up_management.md`.
...
└── page/health_check_up_management/
    ...
    └── health_check_up.md                   ← Tài liệu kỹ thuật chi tiết
